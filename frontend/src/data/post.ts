...
export const Posts: PostMeta[] = [
  ...
  },
  {
    ...
    description:
      'This post explores how a lifelong bond between cousins unraveled over twenty-five dollars, and how what seemed like a small disagreement was really a clash between pride, principle, and the meaning of keeping your word.',
    date: 'March 3rd, 2026',
    tags: ['Personal', 'Mental Health', 'Philosophy'],
  ...
  },
  {
    ...
    description:
      "This post walks through a SSR animation bug I ran into while building a Pyra.js project, how Framer Motion's hydration handoff breaks under certain conditions, and the solution I built into Pyra to handle it.",
    date: 'March 4th, 2026',
  ...
  },
  {
    ...
    description:
      'This post reflects on the meaning of intimacy, questioning whether modern hookup culture has caused us to treat one of the deepest forms of human connection as something casual and disposable.',
  ...
  {
    slug: 'peach',
    title: "Some People Don't like Peaches",
    description: 'This post explores what it really means to stop living for other people’s approval and start understanding yourself. It reflects on the hidden cost of people pleasing, and the uncomfortable truth behind seeking validation',
